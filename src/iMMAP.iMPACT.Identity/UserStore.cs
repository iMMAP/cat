...
namespace iMMAP.iMPACT.Identity
{
                             ...
                             IUserEmailStore<IdentityUser>
    {
        ...
        public UserStore(string dbFile, string password = null)
        {
            this.database = new XodContext(dbFile, password);
            userTable = new UserTable(this.database);
            roleTable = new RoleTable(this.database);
            userRolesTable = new UserRolesTable(this.database);
            userClaimsTable = new UserClaimsTable(this.database);
            userLoginsTable = new UserLoginsTable(this.database);
        }
        ...
        {
            if (user == null)
                throw new ArgumentException("Null or empty argument: user/email");
        ...
        public Task<IdentityUser> FindByEmailAsync(string email)
        {
            ...
            IdentityUser user = userTable.GetUserByEmail(email);
        ...
        public Task<string> GetEmailAsync(IdentityUser user)
        {
            ...
            var u = userTable.GetUserById(user.Id);
        ...
        public Task<bool> GetEmailConfirmedAsync(IdentityUser user)
        {
            ...
            var u = userTable.GetUserById(user.Id);
            return Task.FromResult<bool>(u.EmailConfirmed);
        }
        ...
        public Task SetEmailConfirmedAsync(IdentityUser user, bool emailConfirmed)
        {
            if (user == null)
                throw new ArgumentException("Null or empty argument: user/email");
